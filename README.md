...
프로젝트 자체 코드와 문서는 [MIT 라이선스](LICENSE)로 제공합니다. 저작권·라이선스 고지를 유지하면 사용, 수정, 재배포와 상업적 이용이 가능합니다. 외부 구성요소에는 각 구성요소의 기존 라이선스가 적용되며, 자세한 내용은 [외부 자료와 라이선스](THIRD_PARTY_NOTICES.md)를 참고하세요.
